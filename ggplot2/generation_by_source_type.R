...
VA_annual_energy_generation_mwh <- NULL
...
for(row in 1:nrow(series_list)){
  ...
  if (is.null(VA_annual_energy_generation_mwh))
  {VA_annual_energy_generation_mwh <- dt}
  else
  {VA_annual_energy_generation_mwh <-  merge(VA_annual_energy_generation_mwh, dt[], by ="year", all=TRUE)}
  
}

# Converting units to GWh
VA_annual_energy_generation_gwh<-VA_annual_energy_generation_mwh[,`:=`(total_generation=total_generation/1000,
                                                                       hydro_generation=hydro_generation/1000,
                                                                       nuclear_generation=nuclear_generation/1000,
                                                                       all_solar_generation=all_solar_generation/1000,
                                                                       utility_solar_generation=utility_solar_generation/1000,
                                                                       distributed_solar_generation=distributed_solar_generation/1000)]

VA_annual_energy_generation_gwh[is.na(VA_annual_energy_generation_gwh)]<-0

# Finding sum of total annual renewable generation
VA_annual_energy_generation_gwh<- VA_annual_energy_generation_gwh%>%
...
percent_renewable_and_carbon_free<-VA_annual_energy_generation_gwh[,c(1,9,11)]
...
carbon_free_generation_by_type<-VA_annual_energy_generation_gwh[,c(1,2,3,5,7)]
...
carbon_free_generation_by_type2<-VA_annual_energy_generation_gwh[,c(1,2,3,4,6,7)]
...
carbon_free_generation_by_type3<-VA_annual_energy_generation_gwh[,c(1,3,5,7)]
...
renewable_generation_by_type<-VA_annual_energy_generation_gwh[,c(1,3,4,6)]
...
renewable_and_non_renewable<-VA_annual_energy_generation_gwh[,c(1,8,12)]
...
carbon_and_carbon_free<-VA_annual_energy_generation_gwh[,c(1,10,13)]
...
renewable_and_carbon_free<-VA_annual_energy_generation_gwh[,c(1,2,8,10)]
